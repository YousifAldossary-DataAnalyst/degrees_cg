export default  [
...

    {
        ...
        name: 'Tiktok Hash Tag Generator',
        desc: 'An AI tool that serves as your personal blog post title writer, generating catchy and viral-worthy titles in your chosen language.',
        icon: 'https://cdn-icons-png.flaticon.com/512/7754/7754066.png',
        category: 'blog',
       
        slug: 'tiktok-hash-tag-generator',
        aiPrompt: 'Generate 15 Tiktok hash tag depends on a given keywords and give output in rich text editor format',
        form: [
            {
                label: 'Enter Keywords for your Tiktok hastag',
                field: 'input',
                name: 'keywords',
                required:true
            },
...

    {
        ...
        desc: 'An AI tool that serves as your personal blog post title writer, generating catchy and viral-worthy titles in your chosen language.',
        icon: 'https://cdn-icons-png.flaticon.com/512/4612/4612349.png',
        category: 'blog',
       
        slug: 'tiktok-post-generator',
        aiPrompt: 'Generate 3 trendy Tiktok post depends on a given keywords and give output in rich text editor format',
        form: [
            {
    ...
    {
        name: 'Tiktok Post/Reel Idea',
        desc: 'An AI tool that generate New and trending tiktok idea depends on your niche',
        icon: 'https://cdn-icons-png.flaticon.com/512/3116/3116491.png',
        category: 'tiktok',
       
        slug: 'tiktok-post-idea-generator',
        aiPrompt: 'Generate 5-10 tiktok idea depends on niche with latest trend and give output in rich text editor format',
        form: [
            {
                label: 'Enter Keywords / Niche for your tiktok idea',
                field: 'input',
                name: 'keywords',
                required:true
            },
