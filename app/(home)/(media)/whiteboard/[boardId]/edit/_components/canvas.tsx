...
import { LayerPreview } from "./layer-review";
import { Path } from "./path";
import { SelectionBox } from "./selection-box";
import { useDeleteLayers } from "@/hooks/delete-layers";
...
//WIP: add options upload image + resize image, triangle, line and comment bubble.
const Canvas = ({ boardId }: CanvasProps) => {
  ...
  const insertLayer = useMutation(
    (
      ...
      //WIP: after removing global components return positions to 0 x:-72 y:-120
